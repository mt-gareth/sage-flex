...
class ConsolePublishFlex extends Command
{
	...
	{
		$files = [
			'/stubs/flex/publish/flex/FlexComposer.php' => [ 'dir' => '/app/View/Composers', 'file' => 'Flex.php' ],
			'/stubs/flex/publish/flex/AppJS.js'        => [ 'dir' => '/resources/assets/scripts', 'file' => 'app.js' ],
			'/stubs/flex/publish/flex/AppScss.scss'      => [ 'dir' => '/resources/assets/styles', 'file' => 'app.scss' ],
			'/stubs/flex/publish/flex/IndexJs.js'      => [ 'dir' => '/resources/assets/scripts/flex', 'file' => 'index.js' ],
			'/stubs/flex/publish/flex/IndexScss.scss'    => [ 'dir' => '/resources/assets/styles/flex', 'file' => 'index.scss' ],
		];
